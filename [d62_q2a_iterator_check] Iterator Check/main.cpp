...
int main() {
  ...
  std::cin >> i;
  switch(i) {
    case 1: std::cout << (test1() ? "OK " : "WRONG" ) << std::endl;
    case 2: std::cout << (test2() ? "OK " : "WRONG" ) << std::endl;
    case 3: std::cout << (test3() ? "OK " : "WRONG" ) << std::endl;
    case 4: std::cout << (test4() ? "OK " : "WRONG" ) << std::endl;
    case 5: std::cout << (test5() ? "OK " : "WRONG" ) << std::endl;
    case 6: std::cout << (test6() ? "OK " : "WRONG" ) << std::endl;
    case 7: std::cout << (test7() ? "OK " : "WRONG" ) << std::endl;
    case 8: std::cout << (test8() ? "OK " : "WRONG" ) << std::endl;
    case 9: std::cout << (test9() ? "OK " : "WRONG" ) << std::endl;
    case 10: std::cout << (test10() ? "OK " : "WRONG" ) << std::endl;
  }
}
